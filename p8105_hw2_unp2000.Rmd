...
Some key variables in the precipitation data set are month, year, and total precipitation (in inches). The combined data set (2017 and 2018) encompasses measurements from 24 months in 2017 and 2018. The total number of rows in the combined data set (2017 and 2018) is `r nrow(precip_data)`. The total number of columns in the combined data set (2017 and 2018) is `r ncol(precip_data)`. The total amount of precipitation in the combined data set (2017 and 2018) is `r sum(pull(precip_data, total))` inches. The median amount of precipitation in the combined data set (2017 and 2018) is `r median(pull(precip_data,total))` inches. More specifically, in 2017, the total amount of precipitation was `r sum(pull(precip2_data, total))` inches with a median amount of precipitation was `r median(pull(precip2_data,total))` inches. In 2018, the total amount of precipitation was `r sum(pull(precip1_data, total))` inches while the median amount of precipitation was The median amount of precipitation in 2018 was `r median(pull(precip1_data,total))` inches. 
